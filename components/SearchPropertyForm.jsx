...
const SearchPropertyForm = () => {
  ...
  >
    ...
    <button
      type="submit"
      className="md:ml-4 mt-4 md:mt-0 w-full md:w-auto px-6 py-3 rounded-lg bg-pink-500 text-white hover:bg-pink-600 focus:outline-none focus:ring focus:ring-pink-500"
    >
      Search
    </button>
  </form>
