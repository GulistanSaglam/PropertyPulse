...
const PropertyDetails = ({property}) => {
  return (
    ...
    <div className="bg-white p-6 rounded-lg shadow-md mt-6">
      ...
      <div className="flex justify-center gap-4 text-pink-500 mb-4 text-xl space-x-9">
        <p>
    ...
    <div className="bg-white p-6 rounded-lg shadow-md mt-6">
      ...
      >
        {property.amenities.map((amentiy, index)=> (
                   <li key={index}>
                   <FaCheck className='inline-block text-green-600 mr-2'/> {amentiy}
                 </li>
        ))}
